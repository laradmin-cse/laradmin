...
@section('content')
<h1 class="h3 mb-1 text-gray-800">Other Utilities</h1><!-- Page Heading -->
...
<div class="row"><!-- Content Row -->
    <div class="col-lg-6">
        ...
        <div class="card mb-4"><!-- Progress Small -->
            <div class="card-header py-3">
        ...
        <div class="card mb-4"><!-- Dropdown No Arrow -->
            <div class="card-header py-3">
    ...
    <div class="col-lg-6">
        <div class="card"><!-- Roitation Utilities -->
            <div class="card-header py-3">
