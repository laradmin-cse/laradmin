...
@section('content')
<h1 class="h3 mb-1 text-gray-800">Color Utilities</h1><!-- Page Heading -->
...
<div class="row"><!-- Content Row -->
    <div class="col-lg-4"><!-- First Column -->
        <div class="card shadow mb-4"><!-- Custom Text Color Utilities -->
        ...
        <div class="card shadow mb-4"><!-- Custom Font Size Utilities -->
            <div class="card-header py-3">
    ...
    <div class="col-lg-4"><!-- Second Column -->
        <div class="card shadow mb-4"><!-- Background Gradient Utilities -->
            <div class="card-header py-3">
    ...
    <div class="col-lg-4"><!-- Third Column -->
        <div class="card shadow mb-4"><!-- Grayscale Utilities -->
            <div class="card-header py-3">
